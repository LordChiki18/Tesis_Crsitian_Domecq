...
from aplicaciones.api.serializers import (CiudadSerializer, PersonaSerializer, ClienteSerializer,
                                          PersonaUpdateSerializer, EquipoSerializer)
from aplicaciones.cliente.models import Ciudad, Persona, Cliente
from django_filters.rest_framework import DjangoFilterBackend
from rest_framework import filters
from decimal import InvalidOperation, Decimal

from aplicaciones.ordenes.models import Equipo, OrdenTrabajo, OrdenTrabajoEquipo
...
class EquipoViews(viewsets.ModelViewSet):
